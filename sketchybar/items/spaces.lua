...
local spaceConfigs = {
  ...
  ["3"] = { icon = "󱞁", name = "Notes" },
  ["4"] = { icon = "", name = "Music" },
  ["5"] = { icon = "󱂪", name = "Left Monitor" },
  ["6"] = { icon = "󱂫", name = "Right Monitor" },
  ["7"] = { icon = "󰀶", name = "Finder" },
  ["8"] = { icon = "", name = "Mail" },
  ["9"] = { icon = "", name = "Desktop" },
  ["c"] = { icon = "", name = "Code" },
  ["i"] = { icon = "", name = "Intellij" },
...
local function createWorkspaces()
  sbar.exec(constants.aerospace.LIST_ALL_WORKSPACES, function(workspacesOutput)
    for workspaceName in workspacesOutput:gmatch("[%d%a]") do
      print("creating workspace: " .. workspaceName)
